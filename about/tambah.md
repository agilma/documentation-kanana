---
description: >-
  Berikut adalah tutorial untuk menambahkan/membuat about baru di website
  Kanana.
layout:
  title:
    visible: true
...
Setelah masuk ke bagian "About", akan tampil daftar konten yang telah ditambahkan. Lalu, klik "Create" untuk menambahkan konten baru.

<figure><img src="../.gitbook/assets/3_about_create.png" alt=""><figcaption></figcaption></figure>

## Langkah 4: Isi Form

Setelah masuk ke dalam form, isi form dengan data yang diinginkan.

<figure><img src="../.gitbook/assets/4_about_create.png" alt=""><figcaption></figcaption></figure>
...
Untuk tipe form Teks Editor (About Content) kurang lebih sama seperti Teks, namun perbedaannya Teks Editor memiliki pengaturan untuk tulisannya (seperti bold, italic, dll.).

<figure><img src="../.gitbook/assets/teks_editor.png" alt=""><figcaption></figcaption></figure>
{% endtab %}

{% tab title="Image" %}
Untuk tipe form Image (About Image), ikuti langkah berikut untuk menambahkan Image ke dalam konten.
